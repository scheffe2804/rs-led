...
21. **Jede Kundenmail zuerst an Georg.** Jede neu verfasste E-Mail an einen externen Kunden muss grundsätzlich zuerst als interner Prüfentwurf an `g.schroejahr@rs-led.de` gehen. Vor Georgs Freigabe der exakten Fassung darf kein an den Kunden adressierter Entwurf angelegt werden. Fordert Georg Änderungen oder wird der Text anschließend anderweitig inhaltlich geändert, muss die geänderte Fassung erneut zuerst an Georg. Für gleichlautende Serien- und Nachfassmails gilt ausschließlich die enge Ausnahme in Grundsatz 28.
