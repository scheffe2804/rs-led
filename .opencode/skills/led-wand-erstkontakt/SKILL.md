...
29. **E-Mail-Entwürfe immer mit echtem HTML anlegen.** Jeder neu angelegte interne oder kundenadressierte Mailentwurf muss eine inhaltlich identische Klartextfassung und eine echte HTML-Fassung enthalten. `body_html` darf nicht aus unformatiertem Klartext bestehen, sondern benötigt gültiges HTML, Absatz-Markup wie `<p>` beziehungsweise `<br>` und eine explizite Standardschrift, beispielsweise Aptos mit Arial/Helvetica als Fallback. So kann Outlook die fest hinterlegte Signatur formatiert ergänzen. OpenCode baut die Signatur weiterhin weder in Text noch HTML ein.
...
- Stimmen Klartext- und HTML-Fassung inhaltlich überein und enthalten beide keine manuell eingefügte Signatur?
