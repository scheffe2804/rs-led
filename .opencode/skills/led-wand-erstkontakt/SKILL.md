...
6. **Keine Mail versenden.** Erst einen Entwurf erstellen. Eine vorhandene Freigabe zum Schreiben ist keine Versandfreigabe. Ausnahme für die Entwurfsanlage: Hat Georg die exakte Kundenfassung nach dem verbindlichen Prüfprozess eindeutig freigegeben oder fällt die Fassung zweifelsfrei unter die enge WhatsApp-Freigabe gemäß Grundsatz 21, wird der kundenadressierte Entwurf ohne eine weitere Nutzerfreigabe angelegt; dies ist weiterhin kein tatsächlicher Versand.
7. **Jeden wesentlichen Bearbeitungsschritt sofort in Twenty dokumentieren.** Nicht bis zum Abschluss sammeln und nicht nur den Endstand eintragen. Nach jeder relevanten Quellenprüfung, technischen oder kaufmännischen Erkenntnis, Entscheidung, Nutzer- oder Georg-Korrektur, Entwurfsanlage beziehungsweise -änderung, Freigabe, Versandprüfung, Kundenantwort, Übergabe oder jedem Blocker zuerst den bestehenden Twenty-Kundenvorgang konsistent aktualisieren und kritische Schreibvorgänge zurücklesen; erst danach zum nächsten wesentlichen Schritt übergehen. Opportunity, bestehende Verlaufs-/Prüfnotiz und bestehende Aufgabe fortlaufend pflegen, keine unnötigen Parallelobjekte anlegen. Entwurf, Freigabe, Versand und Antwort strikt getrennt und mit ihrer tatsächlichen Quelle dokumentieren. Eingehende Kundenantworten gehören mit ihrem vollständigen kundenverfassten Inhalt und den verifizierten Mailmetadaten in den zugehörigen Twenty-Kundenvorgang, sofern Twenty sie dort nicht bereits automatisch vollständig und korrekt zugeordnet hat. Reine technische Hilfsaufrufe ohne fachlichen oder prozessualen Aussagewert nicht als künstliche CRM-Ereignisse vervielfältigen; der tatsächliche Bearbeitungsverlauf muss vollständig sein.
...
19. **Das mechanische Raster zuerst intern prüfen.** Nicht vorsorglich fragen, ob geringe Maßanpassungen an ein Modul- oder Kabinettraster zulässig sind. Eine solche Rückfrage ist erst berechtigt, wenn eine für den Anwendungsfall konkret geeignete Serie geprüft wurde und dabei ein tatsächlicher Rasterkonflikt entstanden ist. Dem Kunden dann die konkret realisierbaren Alternativmaße nennen, statt abstrakt nach Maßtoleranz zu fragen. Ist ein wirtschaftlich sinnvolles Standardmaß bereits konkret bestätigt, dieses Maß mit der Begründung nennen, dass es in ein Standardproduktionsraster fällt, und gezielt fragen, ob diese Ausführung passt.
20. **Erforderliche interne Prüfungen durch Georg vollständig und im Dashboard sichtbar nachverfolgen.** Wird eine weiterhin prüfpflichtige Kundenmail zur Ansicht an Georg gegeben, zunächst nur den internen Entwurf dokumentieren. Einen tatsächlichen Versand erst nach Fund im Gesendet-Ordner festhalten. Versandzeit, Empfänger, Betreff und Nachrichten-ID gehören in den bestehenden Twenty-Kundenvorgang. Nach dem verifizierten Prüfversand dieselbe konkrete, Christian zugewiesene Aufgabe sofort mit Status `TODO`, dem Titelpräfix `Georg-Antwort offen ·` und dem verifizierten Versandzeitpunkt als Frist fortführen. Dadurch bleibt sie bis zu Georgs Antwort in Christians Dashboard `Meine TODO-Aufgaben` sichtbar. Georgs Antwort anschließend ebenfalls im Postfach verifizieren und mit Antwortzeit, Nachrichten-ID sowie vollständigem Freigabe- oder Änderungsinhalt in Twenty dokumentieren. Solange keine Antwort vorliegt, ausdrücklich `Antwort ausstehend` festhalten und niemals eine Freigabe unterstellen. Nach der verifizierten Antwort dieselbe Aufgabe auf den tatsächlichen nächsten Schritt, passenden Status und eine sachgerechte neue Frist umstellen oder bei vollständig erledigtem Vorgang schließen. Für Fassungen innerhalb der WhatsApp-Freigabe aus Grundsatz 21 keine Georg-Warteaufgabe anlegen. Keine Parallelaufgabe und keine automatische Drei-Stunden-Eskalation anlegen.
21. **Grundsätzlich zuerst an Georg; enge WhatsApp-Freigabe für feste Sport- und Standard-Nachfassfassungen.** Jede neu verfasste E-Mail an einen externen Kunden muss grundsätzlich zuerst als interner Prüfentwurf an `g.schroejahr@rs-led.de` gehen. Davon ausgenommen sind nach dem vom Nutzer übermittelten WhatsApp-Verlauf mit Georg vom 05.09.2026 ausschließlich (a) etablierte Sport-Erstkontakte nach der festen Sport-Fassung mit beiden Pflichtbroschüren und nur den vorgesehenen Platzhalteranpassungen sowie (b) kurze Standard-Nachfassmails, die nur nach dem Eingang der bisherigen Nachricht beziehungsweise des Angebots und offenen Fragen zum Angebot oder Ablauf fragen und einen bereits freigegebenen Standardabschluss verwenden. Diese beiden Fassungsarten dürfen ohne vorheriges Gegenlesen Georgs als kundenadressierter Entwurf angelegt werden; Georg bleibt in BCC. Abweichungen vom festen Sport-Muster, individuelle technische oder kaufmännische Aussagen, Preise, Angebots- oder Leistungsumfangsänderungen, neue Tonalität oder abweichende Handlungsaufforderungen sowie alle anderen Kundenmails bleiben prüfpflichtig. Vor Georgs Freigabe einer prüfpflichtigen exakten Fassung darf kein Kundenentwurf angelegt werden. Antwortet Georg eindeutig mit `passt`, `ok`, `okay` oder gleichbedeutend, den Kundenentwurf unmittelbar anlegen, Georg in BCC setzen und vollständig prüfen. Fordert Georg Änderungen oder wird der Text anschließend inhaltlich geändert, muss die geänderte Fassung erneut zuerst an Georg. Die WhatsApp-Ausnahme als `vom Nutzer übermittelter WhatsApp-Verlauf mit Georg vom 05.09.2026` dokumentieren, niemals als im Postfach verifizierte Freigabe. Für gleichlautende Serienmails außerhalb dieser Ausnahme gilt zusätzlich Grundsatz 28.
...
28. **Nutzerbestätigung genügt bei gleichlautenden Serienmails.** Werden mehrere inhaltlich gleichlautende Serien- oder Nachfassmails auf Basis eines bereits von Georg freigegebenen Grundmusters erstellt und unterscheiden sie sich ausschließlich in Empfänger, Anrede, Anfragedatum, Abmessungen, Anfragegegenstand oder Betreff, muss Georg nicht jede einzelne Fassung nochmals separat per E-Mail freigeben. Die gleichlautenden Fassungen werden ihm weiterhin vorab als interne Entwürfe vorgelegt. Bestätigt der Nutzer anschließend ausdrücklich, dass Georgs Okay für die Serie beziehungsweise die betreffenden gleichlautenden Fassungen vorliegt, ist diese Bestätigung als ausreichender Freigabenachweis zu behandeln. Sie wird in Twenty als `vom Nutzer bestätigte Freigabe Georgs` dokumentiert und niemals als im Postfach gefundene Antwort ausgegeben. Ändern sich Preis, Angebot, Leistungsumfang, technische Aussage, Tonalität oder Handlungsaufforderung, greift die Ausnahme nicht; dann ist erneut eine individuelle Prüfung durch Georg erforderlich.
29. **E-Mail-Entwürfe immer mit echtem, natuerlich umbrechendem HTML anlegen; Bulwark-Kundenentwürfe genau einmal signieren.** Jeder neu angelegte interne oder kundenadressierte Mailentwurf muss eine inhaltlich identische Klartextfassung und eine echte HTML-Fassung enthalten. Der eigentliche Nachrichtentext verwendet einen einfachen normalen HTML-Textcontainer mit expliziter Standardschrift wie Aptos mit Arial/Helvetica als Fallback, aber keinen Tabellencontainer und keine fixe Breite. Jeder logische Absatz steht in einem eigenen `<div>`- oder `<p>`-Block. Enthaelt ein Absatz mehrere Saetze, duerfen sichtbare Umbrueche nur an vollstaendigen Satzgrenzen gesetzt werden, niemals mitten im Satz. Nicht den gesamten Nachrichtentext in einen einzigen Block oder eine einzige sichtbare Zeile schreiben. Listen als echte `<ol>` beziehungsweise `<ul>` mit `<li>` anlegen. Der Nutzer uebermittelte am 18.08.2026 im Neidel-Vorgang Georgs Klarstellung: normal menschenlesbar umbrechen, nicht mitten im Satz, nicht alles in eine Zeile und nicht auf eine fixe Breite mit einer Tabelle quetschen. Interne Prüfentwürfe an Georg enthalten keine durch OpenCode eingefügte Signatur. Der nach Georgs Freigabe, einer gültigen Serienfreigabe oder innerhalb der engen WhatsApp-Freigabe direkt an den Kunden adressierte Bulwark-Entwurf enthält dagegen genau einmal die verbindlichen Signaturfassungen aus `../../../email-signatur-christian.txt` und `../../../email-signatur-christian.html`. Die Textsignatur nach genau zwei Zeilenumbrüchen als Suffix anhängen. Das HTML mit den unsichtbaren Bulwark-Markern `<p data-signature-block="start"></p><div data-signature-block-node>...</div><p data-signature-block="end"></p>` anhängen, damit Bulwark keine zweite Identitätssignatur ergänzt. Die unveraenderte Signaturtabelle ist von dem Tabellenverbot fuer den Nachrichtentext ausgenommen. Keine sichtbare `--`-Trennzeile verwenden und einen so signierten Entwurf nicht zusätzlich in Outlook signieren.
30. **Klassischen Outlook-/IMAP-Entwurf nach lokaler Signaturänderung synchronisieren.** Bei außerhalb Outlooks angelegten Serverentwürfen kann klassisches Outlook nach dem lokalen Ergänzen der fest hinterlegten Signatur mit `Der Vorgang kann nicht ausgeführt werden, da die Nachricht geändert wurde` blockieren. Dann die geänderte Nachricht mit `Strg+S` manuell speichern, nur das Nachrichtenfenster schließen, mindestens etwa 15 Sekunden beziehungsweise bis nach der IMAP-Synchronisation warten, den Entwurf erneut aus `Entwürfe` öffnen und ohne weitere Änderung senden. Das Deaktivieren des automatischen Speicherns ersetzt diesen Ablauf nicht. Outlook-Profil und OST-Datei nicht ungefragt entfernen oder zurücksetzen.
31. **Nachfassmails kurz, freundlich und ohne Entscheidungsdruck formulieren.** Nur knapp an den bisherigen Vorgang erinnern und fragen, ob die Nachricht oder das Angebot gut angekommen ist und ob Fragen zum Angebot oder Ablauf offen sind. Bevorzugter Standardabschluss nach Georgs Vorgabe vom 18.08.2026: `Gerne bespreche ich offene Punkte auch kurz am Telefon und stehe für Fragen oder Änderungswünsche zur Verfügung.` Die kürzere Formulierung `Gerne bespreche ich offene Punkte auch kurz am Telefon.` hat Georg im selben Vorgang ebenfalls ausdrücklich als in Ordnung bestätigt und sie bleibt für bereits exakt freigegebene oder bewusst sehr knappe Fassungen zulässig; allgemein den längeren Satz bevorzugen. Keine Teilbeauftragung, Bauvoranfrage, Preis- oder Pixelpitch-Optimierung, Angebotsfrist, konkrete Ersparnis oder konkrete Terminfrage ungefragt einbauen; insbesondere nicht routinemäßig `Wann würde es Ihnen passen?` fragen. Technische oder kaufmännische Zusatzthemen nur aufnehmen, wenn der Nutzer oder Georg sie für den konkreten Fall ausdrücklich verlangt oder ein konkreter Kundeninhalt eine sachliche Antwort erfordert. Solche inhaltlichen Zusätze benötigen Georgs individuelle Freigabe der exakten Fassung und fallen nicht unter eine reine Platzhalteranpassung der Serienmail-Ausnahme.
32. **Nach der ersten Nachfassmail exakt 14 Tage bis zur letzten Nachfrage warten und danach schließen.** Sobald der tatsächliche Versand der ersten Nachfassmail im Gesendet-Ordner vollständig verifiziert ist, dieselbe bestehende Twenty-Aufgabe sofort auf exakt 14 Kalendertage nach dem Versandzeitpunkt terminieren. Liegt dann weiterhin keine Kundenantwort vor, eine kurze letztmalige Nachfrage vorbereiten. Sie fragt sinngemäß nur letztmalig nach, ob die bisherige Nachricht beziehungsweise das Angebot vollständig angekommen ist, und weist darauf hin, dass sich der Interessent bei weiteren Fragen gerne melden kann. Bleibt sie bei diesem kurzen Standardinhalt und einem bereits freigegebenen Standardabschluss, darf sie gemäß WhatsApp-Freigabe ohne vorheriges Gegenlesen Georgs als Kundenentwurf mit Georg in BCC angelegt werden. Individuelle technische oder kaufmännische Ergänzungen, eine neue Tonalität oder eine abweichende Handlungsaufforderung bleiben prüfpflichtig. Keine neuen technischen oder kaufmännischen Punkte und keinen Entscheidungsdruck aufnehmen. Erst nach dem tatsächlichen, vollständig verifizierten Versand dieser letzten Nachfrage die bestehende Aufgabe schließen und die Opportunity auf verloren setzen. Ein Entwurf genügt nicht. Bei einer Antwort vor der letzten Nachfrage diese nicht versenden; bei einer späteren Antwort die Opportunity wieder öffnen und einen neuen Task mit Bearbeiter und Frist anlegen. Die Regel gilt für RS-LED-Kundennachfassmails, nicht schematisch für Lieferanten-RFQs, beantwortete Vorgänge oder ausdrücklich anders vereinbarte Kundentermine.
33. **Ausdrücklich beidseitige Anzeigen brauchen zwei freie Ansichtsseiten.** Ist eine Anlage als beidseitig beziehungsweise zweiseitig bespielbar vorgegeben, darf eine gewöhnliche flächenparallele Wandmontage nicht als gleichwertige Standardoption abgefragt oder vorgeschlagen werden, weil sie eine Anzeigeseite verdecken würde. Stattdessen nur geometrisch passende Bauformen klären, zum Beispiel freistehend, an einem Pylon beziehungsweise Mast oder an einer vorhandenen beidseitig zugänglichen Tragkonstruktion. Jede vorgeschlagene Montageart muss beide LED-Flächen sichtbar und für den erforderlichen Service zugänglich lassen. Eine Wand- oder Gebäudebefestigung ist nur dann als Sonderlösung zu behandeln, wenn die konkrete Geometrie nachweislich beide Ansichtsseiten frei lässt.
34. **Bei beidseitigen freistehenden Anzeigen die Unterkante der LED-Fläche klären.** Sobald die Ausführung auf eine freistehende, Pylon-/Mast- oder vergleichbare beidseitig zugängliche Konstruktion hinausläuft und die Höhe noch nicht bekannt ist, im Erstkontakt fragen: `Wie hoch über dem Gelände soll die Unterkante der sichtbaren LED-Fläche liegen?` Nicht stattdessen unscharf nach Gesamt- oder Systemhöhe fragen. Die Unterkante wird für Sichtlinien, Stützenlänge, Außenhöhe, Windlast und Fundamentauslegung benötigt.
35. **Nie direkt nach persönlichem Namen oder Funktion fragen.** Eine ausdrückliche Frage nach Name, persönlichem Ansprechpartner oder Funktion ist im Erstkontakt übergriffig und unterbleibt. Der Kunde nennt diese Angaben freiwillig, wenn er das möchte. Ist kein belastbarer Name bekannt, neutral anreden. Zulässig und bewährt ist ausschließlich die neutrale Formulierung `An wen dürfen wir das Angebot richten?`; sie steht als letzte Frage. Noch nicht von Auftrag oder Rechnung sprechen und im Erstkontakt keine Rechnungsanschrift vorwegnehmen. Eine Liefer- oder Montageadresse nur sachbezogen erfragen, wenn sie für den nächsten technischen Schritt tatsächlich erforderlich ist.
36. **Bei offenkundig großformatigen Publikumsanzeigen Kameraaufnahme intern annehmen.** Steht eine große Sportplatz- oder Veranstaltungsanzeige erkennbar vor einem größeren Publikum und ist bei der Nutzung typischerweise mit Spiel-, Veranstaltungs-, Presse- oder Zuschaueraufnahmen zu rechnen, wird intern davon ausgegangen, dass die LED-Fläche gefilmt werden kann, solange der Kunde nicht ausdrücklich das Gegenteil angegeben hat. Dann nicht routinemäßig nach Kamera- oder Livestreamaufnahme fragen, sondern Kameratauglichkeit und mindestens 3.840 Hz als Planungsannahme behandeln und später am konkreten Produktdatenblatt verifizieren. Keine starre Quadratmeter- oder Zuschauergrenze festlegen; Fläche, Standort, Publikumswirkung und Nutzungsart gemeinsam bewerten. Diese Planungsannahme nicht als Kundenaussage dokumentieren. Ob Videos **auf der Anzeige gezeigt** werden sollen, ist davon vollständig getrennt; eine fehlende Videoanforderung als Inhalt widerlegt die mögliche Kameraaufnahme der Anzeige nicht.
37. **Vor jedem Mailentwurf den aktuellen Twenty-Drafting-Guide laden.** Unmittelbar vor jedem neu angelegten oder inhaltlich beziehungsweise formal überarbeiteten internen oder kundenadressierten E-Mail-Entwurf den aktuellen Twenty-Skill `emailDraftenMitAttachmentsExternerMcp` vollständig laden und lesen. Nicht aus Erinnerung, einer früheren Sitzung oder nur aus dieser lokalen Skill-Datei arbeiten. Der aktuell geladene Twenty-Drafting-Guide ist für technischen Drafting-Ablauf, HTML-Formatierung und Anhangsbehandlung vorrangig. Jede Mail als echtes HTML mit expliziter Standardschrift und natuerlicher Absatzstruktur anlegen: einfacher Textcontainer ohne Tabelle und fixe Breite, eigener Block je logischem Absatz, zusaetzliche Umbrueche nur an Satzgrenzen und niemals mitten im Satz. Bloßer Klartext, alles in einem einzigen Block beziehungsweise einer sichtbaren Zeile oder kuenstlich mitten im Satz umbrochener Text ist nicht ausreichend. Klartext und HTML müssen inhaltlich übereinstimmen. Nach dem Anlegen beide Fassungen vollständig zurücklesen und die natuerliche Absatz- und Satzstruktur maschinell prüfen.
38. **Von Georg fertig übergebene Dokumentations- und Weiterleitungstexte nicht umschreiben.** Kennzeichnet Georg in einer Übergabe bereits fertige Texte ausdrücklich als zu `dokumentieren` beziehungsweise zu `weiterleiten` und verlangt nur, die vorgesehene Adresse einzusetzen, diese Texte unverändert übernehmen und den Entwurf ohne eigene Umformulierung oder inhaltliche Ergänzung fertigstellen. Betreff, Empfänger, BCC, Anhänge und Signatur nach Georgs Vorgabe beziehungsweise den verbindlichen Mailregeln einsetzen und prüfen. Eine technisch erforderliche HTML-Normalisierung darf nur künstliche Zeilenumbrüche mitten im Satz entfernen; Wortlaut, Satzfolge und Inhalt bleiben unverändert.
39. **Kundenanfragen nicht einleitend wiederholen oder paraphrasieren.** Nutzeranweisung vom 11.09.2026 fuer alle kuenftigen Mails, auch Kundenmailtexte in internen Pruefentwuerfen: Nach der Anrede hoechstens kurz danken und direkt zu den notwendigen Fragen oder der konkreten Antwort kommen. Keine Zusammenfassung bekannter Masse, Nutzung oder Wunschinhalte und keine technische Vorrede als Ersatz. Ein gezielter Bezug auf eine bekannte Angabe innerhalb einer notwendigen Frage oder Antwort bleibt zulaessig; ebenso die knappe Zuordnung der bisherigen Nachricht oder des Angebots beim Nachfassen, ohne die Anfrage nachzuerzaehlen. Keine Mindestwortzahl durch Wiederholung auffuellen. Bereits freigegebene exakte Fassungen, feste Muster und unveraendert weiterzuleitende Originaltexte nicht stillschweigend umschreiben; geaenderte pruefpflichtige Fassungen erneut Georg vorlegen. Zentrale Formulierungsregel: Twenty-Artikel `Erstkontakt — Anrede und Angebotsadressierung`.

## Vor dem Arbeiten lesen

Bei jeder neuen OpenCode-Sitzung, in der eine neue oder noch offene LED-Anfrage beziehungsweise ein Erstkontakt bearbeitet wird, zuerst den aktuellen Twenty-Skill `erstkontaktRsLedTechnikLedAnfrage` mit dem Anzeigenamen `Erstkontakt - RS-Led Technik - LED Anfrage` laden und vollständig lesen. Nicht aus dem Gedächtnis oder nur aus dieser lokalen Skill-Datei arbeiten. Der Twenty-Skill ist die aktuelle verbindliche Ablaufquelle; die von ihm vorgeschriebenen Wissensartikel sind vor jedem neuen Erstkontakt-Entwurf ebenfalls aktuell aus Twenty zu lesen. Bei Abweichungen haben der aktuell geladene Twenty-Skill und die aktuellen Twenty-Wissensartikel Vorrang.

Zusätzlich unmittelbar vor **jedem** internen oder kundenadressierten E-Mail-Entwurf den aktuellen Twenty-Skill `emailDraftenMitAttachmentsExternerMcp` vollständig laden und lesen. Diese Pflicht gilt auch innerhalb derselben Sitzung erneut, wenn seit dem letzten Mailentwurf andere fachliche Arbeiten erfolgt sind oder ein neuer Mailvorgang beginnt. Für Drafting-Technik, HTML-Aufbau und Anhänge gilt der aktuell geladene Twenty-Drafting-Guide vor lokalen Erinnerungen oder älteren Beispielen.
...
- Montageart, Anzahl der Ansichtsseiten und Blende; bei ausdrücklich beidseitiger Ausführung nur Bauformen erfassen, die beide LED-Flächen sichtbar und wartbar lassen, und keine gewöhnliche flächenparallele Wandmontage als Option behandeln; bei ausdrücklich `hängend/abgehängt` die vorhandenen Aufhänge- beziehungsweise Befestigungspunkte erfassen und keine Unterkonstruktion ansetzen; bei anderen Montagearten vorhandene Traverse oder tragfähige Anschlusspunkte erfassen und die Unterkonstruktion standardmäßig durch RS-LED behandeln
...
Fehlt eine ausdrückliche Kameraangabe, bei offenkundig großformatigen Sportplatz- oder Veranstaltungsanzeigen vor größerem Publikum trotzdem fallbezogen prüfen, ob eine Kameraaufnahme typischerweise zu erwarten ist. Wenn das Gesamtbild aus Fläche, Standort, Publikumswirkung und Nutzung dies klar nahelegt und kein ausdrücklicher Ausschluss vorliegt, die Kameraaufnahme intern als Planungsannahme setzen, nicht erneut beim Kunden abfragen und mindestens 3.840 Hz für die Produktauswahl verifizieren. Keine feste Flächen- oder Zuschauergrenze erfinden. Eine fehlende Anforderung, Videos auf der Anzeige zu zeigen, ist hiervon unabhängig.
...
Prüfen, ob die Anzeigefläche für die Entfernung und den Inhalt überhaupt groß genug ist. Als anschauliche Näherung:

```text
scheinbare Breite aus 1 m = Wandbreite / Betrachtungsabstand
scheinbare Höhe aus 1 m = Wandhöhe / Betrachtungsabstand
```
...
Erst nach der Größenprüfung bewerten:

- Gesamtauflösung aus Abmessungen und Pitch berechnen oder verifizieren.
- Prüfen, ob diese Auflösung für den konkreten Inhalt reicht.
- P10 nicht pauschal als ausreichend bezeichnen, nur weil der Abstand groß ist.
- Ein feinerer Pitch kann Bilder verbessern, behebt aber keine zu kleine physische Fläche.
- Alternative Pitches später mit Preis ausweisen, wenn unterschiedliche Inhaltsarten realistisch sind.
...
### 3. Checkliste fallbezogen prüfen

Ergebnis in drei Gruppen gliedern:

#### Bereits geklärt

Nur Daten aufführen, die aus der Anfrage oder einer verlässlichen Quelle stammen.
...
- bei einer konkret bestätigten wirtschaftlichen Rasteralternative das realisierbare sichtbare Maß und den Vorteil des Standardproduktionsrasters nennen, statt weiter abstrakt zwischen LED-Fläche und Außenmaß zu unterscheiden
...
- bei ausdrücklich beidseitiger beziehungsweise zweiseitiger Anzeige die Montagefrage auf freistehende, Pylon-/Mast- oder vorhandene beidseitig zugängliche Tragkonstruktionen begrenzen; eine gewöhnliche flächenparallele Wandmontage nicht anbieten, weil sie eine Seite verdeckt
...
Bewusst dokumentieren, zum Beispiel:

- keine Outdoor-Windlast bei bestätigter Indoor-Festinstallation
- keine Kameraanforderung bei bestätigtem Verzicht auf Kamera/Livestream
- Kameraaufnahme als interne Planungsannahme bei offenkundig großformatiger Publikumsanzeige, sofern sie nicht ausdrücklich ausgeschlossen wurde; dies ist keine Kundenaussage
- keine Flightcases bei einer endgültigen Festinstallation

### 4. Stop-Gate Angebotsreife

Den Lead auf **noch nicht angebotsreif** setzen, wenn mindestens einer dieser Punkte fehlt:
...
Erst nach Auflösung der Blocker Produkt, Lieferzeit, Marge oder Endpreis festlegen.
...
- Wenn der Angebotsempfänger noch nicht bekannt ist, als letzte Frage ausschließlich die bewährte neutrale Formulierung `An wen dürfen wir das Angebot richten?` verwenden. Nie direkt nach persönlichem Namen, Funktion oder Ansprechpartner und im Erstkontakt nicht nach einer Rechnungsanschrift fragen. Eine Liefer- oder Montageadresse nur sachbezogen erfragen, wenn sie für den nächsten technischen Schritt tatsächlich erforderlich ist.
...
Nie fragen, ob es ein Eigen- oder Kundenprojekt ist, wie der persönliche Name oder die Funktion lautet, wer als persönlicher Ansprechpartner auftritt, wem Grundstück, Gebäude oder Montageort gehören, ob die Aufstellung intern bereits abgestimmt wurde, wer die Unterkonstruktion übernimmt, welcher Mediaplayer gewünscht ist oder ob das Konfigurator-Maß die LED-Fläche beziehungsweise das Außenmaß einschließlich Blende bezeichnet. Bei fehlendem Namen neutral anreden. Für die Angebotsadressierung ausschließlich `An wen dürfen wir das Angebot richten?` als letzte Frage verwenden; noch nicht nach einer Rechnungsanschrift fragen. Eine Liefer- oder Montageadresse nur sachbezogen erfragen, wenn sie für den nächsten technischen Schritt tatsächlich erforderlich ist. Bei anderen Montagearten und einer fehlenden Traverse oder fehlenden tragfähigen Anschlusspunkten ankündigen, dass RS-LED die erforderliche Unterkonstruktion mit einplant. Bei ausdrücklich `hängend/abgehängt` dagegen niemals eine Unterkonstruktion abfragen, ankündigen oder einplanen. Auch nicht erneut fragen, ob die Wand dauerhaft hängen oder für Veranstaltungen auf- und abgebaut werden soll. Stattdessen beispielsweise fragen: `An welchen vorhandenen Aufhänge- beziehungsweise Befestigungspunkten soll die abgehängte LED-Wand befestigt werden?` Der VNNOX-Mediaplayer wird ohne Rückfrage als Bestandteil des Angebots vorgesehen. Behördliche Genehmigungen und bauseitige Freigaben bei Bedarf später als kundenseitige Voraussetzung im Angebot abgrenzen.

Bei ausdrücklich beidseitigen Anzeigen muss auch die Formulierung der Montagefrage die zwei freien Ansichtsseiten respektieren. Nicht pauschal `freistehend, an einer Wand oder an einer vorhandenen Konstruktion` zur Auswahl stellen. Stattdessen beispielsweise fragen: `Soll der beidseitige Screen freistehend, an einem Pylon beziehungsweise Mast oder an einer vorhandenen beidseitig zugänglichen Tragkonstruktion montiert werden?` Eine gewöhnliche flächenparallele Wandmontage scheidet aus, weil sie eine LED-Seite verdecken würde.

Ist bei einer solchen beidseitigen Konstruktion die Aufstellhöhe noch offen, zusätzlich konkret nach der Unterkante der sichtbaren LED-Fläche über dem Gelände fragen. Wurde intern bereits ein wirtschaftlich passendes Standardmaß bestätigt, dieses in derselben Erstkontaktstufe als konkreten Angebotsansatz nennen, zum Beispiel: `Aus wirtschaftlichen Gründen würden wir das Angebot auf Basis einer sichtbaren LED-Fläche von 2,00 × 1,00 m je Anzeigeseite erstellen, da dieses Maß in ein Standardproduktionsraster fällt. Ist diese Größe für Sie passend?`
...
### Verbindliche Vorabkontrolle prüfpflichtiger Kundenmails durch Georg

Jeder prüfpflichtige Erstkontakt und jede andere prüfpflichtige neu verfasste Kundenmail geht grundsätzlich zuerst an Georg zur Ansicht. Feste Sport-Erstkontakte und kurze Standard-Nachfassmails innerhalb der engen WhatsApp-Freigabe aus Grundsatz 21 benötigen diese Vorabkontrolle nicht. Bei allen anderen Fassungen wird vor Georgs Freigabe der exakten Fassung kein kundenadressierter Entwurf angelegt:
...
3. Nach erfolgreicher Verifizierung eines erforderlichen Prüfversands Versandzeit, Empfänger, Betreff, Nachrichten-ID und gegebenenfalls Thread-ID in der vorhandenen verknüpften Notiz dokumentieren. Opportunity auf `Georgs Antwort abwarten` setzen. Dieselbe konkrete, Christian zugewiesene Aufgabe mit Status `TODO`, dem Titelpräfix `Georg-Antwort offen ·` und dem verifizierten Versandzeitpunkt als Frist fortführen, damit sie in Christians Dashboard `Meine TODO-Aufgaben` sichtbar bleibt. Veraltete Hinweise, die noch von einem unversendeten Entwurf ausgehen, bereinigen. Für Fassungen innerhalb der WhatsApp-Freigabe keine Georg-Warteaufgabe anlegen. Keine Parallelaufgabe und keine automatische Drei-Stunden-Eskalation anlegen.
...
5. Ist bei einer prüfpflichtigen Fassung noch keine Antwort vorhanden, grundsätzlich `Antwort ausstehend` dokumentieren und die bestehende Dashboard-Aufgabe unverändert als `TODO` mit `Georg-Antwort offen ·` beibehalten. Weder das Versenden der Prüfmail noch das Ausbleiben einer Antwort ist allein eine Freigabe. Erst nach einer im Postfach verifizierten Reaktion Georgs dieselbe Aufgabe auf den tatsächlichen nächsten Schritt und eine passende neue Frist umstellen oder bei vollständig erledigtem Vorgang schließen.
6. Serienmail-Ausnahme: Bei mehreren inhaltlich gleichlautenden Serien- oder Nachfassmails auf Basis eines bereits freigegebenen Grundmusters ist keine separate Antwort Georgs pro Empfänger erforderlich. Bestätigt der Nutzer ausdrücklich, dass Georgs Okay für die betreffende Serie oder die gleichlautenden Fassungen vorliegt, dokumentieren, welche Fassungen beziehungsweise Empfänger davon umfasst sind. Als Quelle `vom Nutzer bestätigte Freigabe Georgs` festhalten; keine Antwortzeit oder Nachrichten-ID erfinden. Nur Platzhalteränderungen bei Empfänger, Anrede, Anfragedatum, Abmessungen, Anfragegegenstand und Betreff sind abgedeckt.
7. Nach einer im Postfach nachgewiesenen eindeutigen Freigabe der exakten Fassung den kundenadressierten Entwurf unmittelbar ohne weitere Nutzerfreigabe anlegen, Georg in BCC setzen und Empfänger, Betreff, Klartext, echtes HTML sowie Anhänge prüfen. In Bulwark die verbindliche Outlook-identische Kompaktsignatur in Text und HTML genau einmal mit den Signaturmarkern anhängen und auf Doppel-Signatur prüfen. Dasselbe gilt nach einer gültigen Nutzerbestätigung gemäß Serienmail-Ausnahme oder bei einer zweifelsfrei unter Grundsatz 21 fallenden WhatsApp-Ausnahme. Enthält Georg Änderungen oder weichen Preis, Angebot, Leistungsumfang, technische Aussage, Tonalität oder Handlungsaufforderung ab, zuerst Mailtext, Checklistenprüfung, Opportunity und Aufgabe konsistent aktualisieren und die geänderte Fassung erneut an Georg zur Prüfung geben.
...
1. Unmittelbar vor der Entwurfsanlage den aktuellen Twenty-Skill `emailDraftenMitAttachmentsExternerMcp` vollständig laden und lesen. Danach den vollständigen Kundenentwurf im Postfach anlegen oder aktualisieren und Empfänger, Betreff, Klartextfassung sowie echte HTML-Fassung prüfen. Der eigentliche Nachrichtentext muss einen einfachen normalen HTML-Textcontainer mit expliziter Standardschrift, aber ohne Tabelle und fixe Breite verwenden. Jeder logische Absatz steht in einem eigenen `<div>`- oder `<p>`-Block. Enthaelt ein Absatz mehrere Saetze, duerfen sichtbare Umbrueche nur an vollstaendigen Satzgrenzen gesetzt werden, niemals mitten im Satz. Nicht den gesamten Nachrichtentext in einen einzigen Block oder eine einzige sichtbare Zeile schreiben. Listen als echte `<ol>` beziehungsweise `<ul>` mit `<li>` anlegen. Blosser Klartext in `body_html`, kuenstliche Umbrueche mitten im Satz oder ein Tabellen-/Breitenlayout fuer den Nachrichtentext sind nicht zulaessig. Der von Georg freigegebene Nachrichtentext muss in Text und HTML inhaltlich übereinstimmen. In Bulwark die verbindliche Signatur in beiden Fassungen genau einmal als Suffix anhängen; im HTML müssen Start-, Block- und Endmarker jeweils genau einmal vorkommen, damit keine zweite Identitätssignatur ergänzt wird. Die unveraenderte Signaturtabelle ist zulaessig. Keine sichtbare `--`-Trennzeile verwenden. Georg unter `g.schroejahr@rs-led.de` ausnahmslos in BCC setzen und diesen BCC-Eintrag verifizieren. Keine Bilder selbst einbetten oder anhängen; sie werden vom Nutzer ergänzt. Andere ausdrücklich beauftragte Anhänge prüfen.
2. Wenn der Nutzer die Outlook-Signatur lokal ergänzt und klassisches Outlook beim Senden meldet, die Nachricht sei geändert worden, den bestätigten IMAP-Ablauf verwenden: `Strg+S`, nur das Nachrichtenfenster schließen, mindestens etwa 15 Sekunden beziehungsweise bis nach der Synchronisation warten, den Entwurf erneut öffnen und ohne weitere Änderung senden. Das Profil oder die OST-Datei nicht ungefragt zurücksetzen.
3. Danach genau einmal fragen: `Hast du die Mail im Postfach versendet?`
4. Bis zur Bestätigung beziehungsweise Verifizierung im Gesendet-Ordner nur `Entwurf angelegt · nicht versendet` dokumentieren. Niemals allein aus Versandauftrag oder Entwurfsstatus einen tatsächlichen Versand ableiten.
5. Nach der Bestätigung im Gesendet-Ordner nach Empfänger und Betreff suchen und die gefundene Nachricht vollständig prüfen. Falls sie noch nicht auffindbar ist, die Nutzerbestätigung dokumentieren und die technische Verifizierung als offen kennzeichnen.
...
7. Den nächsten Schritt auf `Kundenantwort abwarten` setzen und ein sinnvolles erstes Nachfassdatum dokumentieren. Wird spaeter eine erste Nachfassmail tatsaechlich versendet, nach deren vollstaendiger Verifizierung dieselbe Aufgabe sofort auf exakt 14 Kalendertage nach dem Versandzeitpunkt setzen. Bei weiterhin ausbleibender Antwort dann die kurze letztmalige Standardnachfrage vorbereiten. Bleibt sie innerhalb der WhatsApp-Freigabe, den Kundenentwurf ohne vorheriges Gegenlesen mit Georg in BCC anlegen; individuelle Zusätze zuerst durch Georg prüfen lassen. Erst nach dem verifizierten Kundenversand Aufgabe schliessen sowie Opportunity auf verloren setzen.
...
- Wurde bei einer ausdrücklich beidseitigen Anzeige auf die widersprüchliche Standardoption einer gewöhnlichen flächenparallelen Wandmontage verzichtet und eine Bauform abgefragt, die beide Ansichtsseiten frei und wartbar lässt?
- Wurde bei einer beidseitigen freistehenden beziehungsweise Pylon-/Mast-Ausführung die noch fehlende Unterkante als Höhe der sichtbaren LED-Fläche über dem Gelände abgefragt?
- Wurde bei einer bestätigten wirtschaftlichen Rasteralternative das konkrete Standardmaß genannt, statt weiterhin abstrakt nach Maßtoleranz oder Außenmaß zu fragen?
...
- Wurde bei einer offenkundig großformatigen Sportplatz- oder Veranstaltungsanzeige vor größerem Publikum die mögliche Kameraaufnahme fallbezogen intern angenommen, statt sie routinemäßig erneut abzufragen, und klar von Video als Anzeigeinhalt getrennt?
...
- Wurde korrekt entschieden, ob die Fassung zweifelsfrei unter Georgs enge WhatsApp-Freigabe für feste Sport-Erstkontakte oder kurze Standard-Nachfassmails fällt oder weiterhin vorab prüfpflichtig ist?
- Bleibt nach einem verifizierten erforderlichen Prüfversand an Georg dieselbe Christian zugewiesene Aufgabe als `TODO` mit dem Titelpräfix `Georg-Antwort offen ·` und dem Versandzeitpunkt als Frist in Christians Dashboard sichtbar, solange keine eindeutige Antwort verifiziert ist, und wurde bei Fassungen innerhalb der WhatsApp-Freigabe auf eine Georg-Warteaufgabe verzichtet?
- Wurde Georgs tatsächliche Antwort mit Antwortzeit, Nachrichten-ID und vollständigem Freigabe- oder Änderungsinhalt dokumentiert oder bei einer gültigen Serienmail-Ausnahme die ausdrückliche Nutzerbestätigung mit ihrem genauen Geltungsbereich als solche festgehalten?
- Wurde vor dem Anlegen eines kundenadressierten Entwurfs entweder Georgs Freigabe der exakten prüfpflichtigen Fassung nachgewiesen, eine gültige Nutzerbestätigung gemäß Serienmail-Ausnahme dokumentiert oder die zweifelsfreie Anwendbarkeit der WhatsApp-Freigabe wahrheitsgemäß festgehalten?
- Wurde nach jeder inhaltlichen Änderung einer prüfpflichtigen Fassung erneut Georgs Freigabe eingeholt beziehungsweise bei einer Fassung innerhalb der WhatsApp-Ausnahme geprüft, dass sie weiterhin ausschließlich dem festen Standard entspricht?
- Ist die Nachfassmail kurz, freundlich und ohne Entscheidungsdruck, fragt sie nur nach dem Eingang und offenen Fragen und verwendet sie bevorzugt Georgs Standardabschluss `Gerne bespreche ich offene Punkte auch kurz am Telefon und stehe für Fragen oder Änderungswünsche zur Verfügung.`? Wird die kürzere bestätigte Alternative nur bei bereits exakt freigegebenen oder bewusst sehr knappen Fassungen verwendet? Wurden Teilbeauftragung, Bauvoranfrage, Preis- oder Pixelpitch-Optimierung, Frist und konkrete Terminfrage weggelassen, sofern der Nutzer oder Georg keinen solchen Zusatz ausdrücklich für den Einzelfall verlangt hat?
- Wurde nach dem verifizierten Versand einer ersten Nachfassmail dieselbe bestehende Aufgabe exakt 14 Kalendertage nach dem Versandzeitpunkt terminiert? Wird bei weiterhin ausbleibender Antwort nur eine kurze letztmalige Standardnachfrage vorbereitet, bei Einhaltung der WhatsApp-Freigabe ohne Georg-Vorprüfung mit Georg in BCC angelegt und werden Aufgabe sowie Opportunity erst nach deren tatsächlich verifiziertem Kundenversand geschlossen beziehungsweise auf verloren gesetzt?
...
- Wurde unmittelbar vor diesem Mailentwurf der aktuelle Twenty-Skill `emailDraftenMitAttachmentsExternerMcp` vollständig geladen und gelesen und wurde dessen aktueller Ablauf verwendet?
- Enthaelt der Entwurf neben der Klartextfassung eine echte, gueltige HTML-Fassung mit expliziter Standardschrift und natuerlicher Absatzstruktur? Wurde maschinell bestaetigt, dass der eigentliche Nachrichtenteil vor den Signaturmarkern keinen Tabellencontainer und keine fixe Breite enthaelt, jeder logische Absatz einen eigenen Block bildet, kein manueller Umbruch mitten im Satz vorkommt und der Text nicht als ein einziger Block beziehungsweise eine einzige sichtbare Zeile angelegt ist?
